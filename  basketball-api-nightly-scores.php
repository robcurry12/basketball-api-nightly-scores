 ...
 * Description: Emails nightly basketball stat summaries via CSV. Flashscore scanning fields live on each Player (rba_player) post; the admin page chooses which players are included in the nightly crawl. Scraping runs externally (e.g. GitHub Actions) and is pushed into WordPress via REST.
 * Version: 3.0.0
 * Author: Rob Curry
 */
...
define( 'BANS_PLUGIN_VERSION', '3.0.0' );
